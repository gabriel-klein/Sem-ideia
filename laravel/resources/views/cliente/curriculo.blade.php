    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('cliente/conhecimento') }}"> 
                        @csrf
 ...
 <div class="form-group row">
  ...
  <div class="col-md-6">
    <select id="escolaridade" class="custom-select @error('escolaridade') is-invalid @enderror" 
      ...
      <option value="Superior_completo" {{ ((old('escolaridade') == "Superior_completo") || (@$vaga->escolaridade == "Superior_completo"))?"selected":"" }}>Superior Completo</option>
      <option value="Superior_incompleto" {{ ((old('escolaridade') == "Superior_incompleto") || (@$vaga->escolaridade == "Superior_incompleto"))?"selected":"" }}  >Superior Incompleto</option>
      <option value="Médio_completo" {{ ((old('escolaridade') == "Médio_completo") || (@$vaga->escolaridade == "Médio_completo"))?"selected":"" }} >Médio Completo</option>
      <option value="Médio_incompleto" {{ ((old('escolaridade') == "Médio_incompleto") || (@$vaga->escolaridade == "Médio_incompleto"))?"selected":"" }}  >Médio Incompleto</option>
      <option value="Fundamental_completo" {{ ((old('escolaridade') == "Fundamental_completo") || (@$vaga->escolaridade == "Fundamental_completo"))?"selected":"" }}>Fundamental Completo</option>
      <option value="Fundamental_incompleto" {{ ((old('escolaridade') == "Fundamental_incompleto") || (@$vaga->escolaridade == "Fundamental_incompleto"))?"selected":"" }}>Fundamental Incompleto</option>
    </select>
    @error('escolaridade')
                                ...
                                <div class="col-md-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" required id="excel_Básico" name="excel" value="Básico"
                                            class="custom-control-input @error('excel') is-invalid @enderror" {{ old('excel') == "Básico"? 'checked': '' }}>
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="excel_Intermediário" name="excel" value="Intermediário"
                                            class="custom-control-input @error('excel') is-invalid @enderror" {{ old('excel') == "Intermediário"? 'checked': '' }}>
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="excel_Avançado" name="excel" value="Avançado"
                                            class="custom-control-input @error('excel') is-invalid @enderror" {{ old('excel') == "Avançado"? 'checked': '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" required id="word_Básico" name="word" value="Básico"
                                            class="custom-control-input @error('word') is-invalid @enderror" {{ old('word') == "Básico"? 'checked': '' }}>
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="word_Intermediário" name="word" value="Intermediário"
                                            class="custom-control-input @error('word') is-invalid @enderror" {{ old('word') == "Intermediário"? 'checked': '' }}>
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="word_Avançado" name="word" value="Avançado"
                                            class="custom-control-input @error('word') is-invalid @enderror" {{ old('word') == "Avançado"? 'checked': '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" required id="ingles_Básico" name="ingles" value="Básico"
                                            class="custom-control-input @error('ingles') is-invalid @enderror" {{ old('ingles') == "Básico"? 'checked': '' }}>
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="ingles_Intermediário" name="ingles" value="Intermediário"
                                            class="custom-control-input @error('ingles') is-invalid @enderror" {{ old('ingles') == "Intermediário"? 'checked': '' }}>
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="ingles_Avançado" name="ingles" value="Avançado"
                                            class="custom-control-input @error('ingles') is-invalid @enderror" {{ old('ingles') == "Avançado"? 'checked': '' }}>
